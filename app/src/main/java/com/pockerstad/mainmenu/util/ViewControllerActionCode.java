...
public final class ViewControllerActionCode {
    ...
    public static final int ADD_FIRST_OPPONENT = 301 ;
    public static final int ADD_SECOND_OPPONENT = 302 ;
    public static final int ADD_THIRD_OPPONENT = 303 ;
    public static final int ADD_FOURTH_OPPONENT = 304 ;
